...
import {studentsNav} from "../constants/index.js";
    ...
    return (
        <div className={`fixed top-0 left-0 w-full z-50 border-b border-n-6 
            ...
            <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
                ...
                <Button className={"hidden text-xs lg:flex lg:text-lg mr-2"} href="/teaching/teachers">
                    {"Teacher's page"}
                </Button>
                <Button className={"hidden text-xs lg:flex lg:text-lg"} href="/">
                    Return to home
                </Button>
